...
Take a short look at the Healthcare Robotics Dashboard in action! Watch the video demonstration:[Healthcare Robotics Dashboard - Short Video](./videos/Healthcare_Robotics_Dashboard_Short_Video.mov) to explore its interactive features and insights.
